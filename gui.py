...
"    ")
        ...
        self.btn_play_linked = QtWidgets.QPushButton(self.centralwidget)
        self.btn_play_linked.setText("")
        self.btn_play_linked.setIcon(icon2)
        self.btn_play_linked.setObjectName("btn_play_linked")
        self.horizontalLayout_3.addWidget(self.btn_play_linked)
        self.btn_pan_left_linked = QtWidgets.QPushButton(self.centralwidget)
        self.btn_pan_left_linked.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icons/left_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_pan_left_linked.setIcon(icon6)
        self.btn_pan_left_linked.setObjectName("btn_pan_left_linked")
        self.horizontalLayout_3.addWidget(self.btn_pan_left_linked)
        self.btn_pan_right_linked = QtWidgets.QPushButton(self.centralwidget)
        self.btn_pan_right_linked.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/right_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_pan_right_linked.setIcon(icon7)
        self.btn_pan_right_linked.setObjectName("btn_pan_right_linked")
        self.horizontalLayout_3.addWidget(self.btn_pan_right_linked)
        self.btn_speed = QtWidgets.QPushButton(self.centralwidget)
        self.btn_speed.setMinimumSize(QtCore.QSize(30, 30))
        self.btn_speed.setObjectName("btn_speed")
        self.horizontalLayout_3.addWidget(self.btn_speed)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_speed.setText(_translate("MainWindow", "x1.0"))
