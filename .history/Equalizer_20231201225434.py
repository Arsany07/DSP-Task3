...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.gui.plot_input_sig_time.addItem(medPlayer_seeker_input)
        ...
        self.gui.plot_input_sig_time.addItem(medPlayer_seeker_output)
    ...
    def update_seeker_bar(self, player:QMediaPlayer, plot:pg.PlotWidget):
