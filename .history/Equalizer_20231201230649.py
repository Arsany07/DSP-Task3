...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.media_player_output.positionChanged(lambda position: self.medPlayer_seeker.setValue(position))
        
        # Allow Scrubbing with seeker
        self.medPlayer_seeker.sigPositionChangeFinished.connect(self.media_player_input.setPosition())
        self.medPlayer_seeker.sigPositionChangeFinished.connect(self.media_player_output.setPosition())
