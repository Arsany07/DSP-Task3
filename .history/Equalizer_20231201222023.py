...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.gui.btn_pan_left_linked.clicked.connect(lambda: pass)
        self.gui.btn_pan_right_linked.clicked.connect(lambda: pass)
        self.gui.btn_play_linked.clicked.connect(lambda: pass)
        self.gui.btn_zoom_in.clicked.connect(lambda: pass)
        self.gui.btn_zoom_out.clicked.connect(lambda: pass)
