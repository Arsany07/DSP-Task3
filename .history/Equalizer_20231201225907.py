...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        medPlayer_seeker = pg.InfiniteLine(pos = self.media_player_input.position(), angle = 90, pen = pg.mkPen('y'), movable =  True)
        self.gui.plot_input_sig_time.addItem(medPlayer_seeker)
        ...
        self.gui.plot_output_sig_time.addItem(medPlayer_seeker)
