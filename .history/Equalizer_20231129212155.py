...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        # Connect the button click event to the play_file method
        self.gui.btn_play_input_output.clicked.connect(lambda: self.play_file(self.media_player_output, path="output.wav"))
        self.gui.btn_rewind_input_output.clicked.connect(lambda: self.restart_file(self.media_player_output, path="output.wav"))
