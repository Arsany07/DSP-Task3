...
from gui_diff import Ui_MainWindow
import os
...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.gui.btn_play_input.clicked.connect(self.play_file)

        self.gui.btn_rewind_input.clicked.connect(self.restart_file)

        self.gui.btn_pan_left_input.clicked.connect(self.seek_backward)
        self.gui.btn_pan_right_input.clicked.connect(self.seek_forward)
