...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.medPlayer_seeker.sigPositionChangeFinished.connect(lambda value: self.media_player_input.setPosition(value))
        self.medPlayer_seeker.sigPositionChangeFinished.connect(lambda value: self.media_player_output.setPosition(value))
